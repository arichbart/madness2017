...
class BestTeams extends Controller
{
	public function getTeamScores(){
		if (Auth::check()) {
			if (carbon::now() < "2024-03-21 16:15:00.000000" && Auth::user()->name != 'Aaron Richbart') {
				return redirect('/home')
					->withErrors('Best teams will be available after the first game begins on Thursday at 12:15pm Eastern');
			}
